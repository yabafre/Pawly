...
const allNavItems = [
  ...
  {
    href: '/dashboard/school-days',
    icon: GraduationCap,
    labelKey: 'schoolDays' as const,
    apprenticeOnly: true,
  },
    ...
    <div className="min-h-dvh bg-background text-foreground font-sans">
      ...
      <header className="sticky top-0 z-50 w-full bg-background/90 backdrop-blur-md border-b border-border/40">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 h-14 flex items-center justify-between">
          <span data-tour="employee-greeting">
            <PawlyLogo />
          </span>
      ...
      {/* Main content */}
      <main className="max-w-4xl mx-auto px-4 sm:px-6 pt-6 pb-32 sm:pb-8">{children}</main>
