    ...
    return (
        <div className="space-y-6 animate-in slide-in-from-right duration-500">
            <div className="flex items-center gap-4 mb-8">
                ...
                <h2 className="text-2xl font-bold">{t("newRequest")}</h2>
            </div>

            <div className="space-y-2">
                <label className="text-sm font-bold text-neutral-400 uppercase tracking-wider ml-2">
                    {t("absenceType")}
                </label>
                ...
                <Card onClick={navigateToRequest} className="p-4 flex flex-col justify-between h-36 hover:bg-neutral-50 border-dashed border-2 border-neutral-200 shadow-none">
                    ...
                    <div>
                        <div className="font-bold text-lg text-neutral-900">
                            {t("requestAbsence").split(" ").slice(0, 1).join(" ")}
                            <br />
                            {t("requestAbsence").split(" ").slice(1).join(" ")}
                        </div>
                        <div className="text-xs text-neutral-500 mt-1">{t("absenceTypes")}</div>
                    </div>
                </Card>
            </div>
