  ...
  if (step === 'list') {
    return (
      <div className="space-y-5">
        ...
        <Button
          data-tour="employee-absence-request"
    ...
    return (
      <div className="space-y-5">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-lg font-semibold tracking-tight">{tForm('selectType')}</h1>
        </div>
  ...
  return (
    <div className="space-y-5">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-lg font-semibold tracking-tight">{tForm('dateRange')}</h1>
