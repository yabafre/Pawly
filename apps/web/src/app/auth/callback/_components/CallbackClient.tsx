            ...
            <Card className="w-full max-w-md text-center shadow-[0_8px_30px_rgba(0,0,0,0.04)] border-neutral-100 bg-white/90 backdrop-blur-sm">
                {status === "error" ? (
                    <CardHeader className="space-y-3">
                        ...
                        <CardTitle className="text-xl font-bold text-neutral-900">Lien invalide</CardTitle>
                        <CardDescription className="text-neutral-500">
                            Le lien est expiré ou déjà utilisé. Veuillez redemander un magic link.
                        </CardDescription>
                        <Button
                            type="button"
                    ...
                    <CardHeader className="space-y-3">
                        ...
                        <CardTitle className="text-xl font-bold text-neutral-900">
                            {status === "success" ? "Connexion validée" : "Validation en cours"}
                        </CardTitle>
                        <CardDescription className="text-neutral-500">
                            {status === "success" ? "Redirection en cours..." : (isPending ? "Nous vérifions votre lien sécurisé." : "Préparation de votre session...")}
                        </CardDescription>
                    </CardHeader>
                )}
            </Card>
