...
export function Pricing() {
	return (
		<section className="w-full relative overflow-hidden py-16 md:py-32">
			<div className="mx-auto w-full max-w-6xl space-y-5 px-4">
				...
				<div className="relative">
					...
					>	
						<div className="grid md:grid-cols-2 bg-[#0A0A0A] rounded-[2rem] overflow-hidden relative border border-white/5 p-2 sm:p-4 shadow-2xl">
							<PlusIcon className="absolute -top-3 -left-3 size-5 text-neutral-600" />
							<PlusIcon className="absolute -top-3 -right-3 size-5 text-neutral-600" />
							<PlusIcon className="absolute -bottom-3 -left-3 size-5 text-neutral-600" />
							<PlusIcon className="absolute -bottom-3 -right-3 size-5 text-neutral-600" />

							<div className="w-full px-6 pt-8 pb-6 bg-[#111111] rounded-[1.5rem] border border-white/5 shadow-inner">
							...
							<div className="relative w-full rounded-[1.5rem] border border-primary/20 bg-primary/5 px-6 pt-8 pb-6 ml-0 md:ml-4 mt-4 md:mt-0">
								<BorderTrail
									style={{
										boxShadow:
