...
export function PawlyLogo({ className, iconClassName }: { className?: string, iconClassName?: string }) {
    return (
        <div className={cn("flex items-center gap-3", className)}>
            <div className={cn("w-10 h-10 bg-[#009588] rounded-xl flex items-center justify-center shadow-lg shadow-teal-900/10 relative overflow-hidden group shrink-0", iconClassName)}>
