...
export const skillRequirementConfigSchema = z.object({
  shiftTypeCode: z.string().min(1, 'Shift type code is required'),
  requiredJobTypes: z.array(z.string().min(1)).min(1, 'At least one required job type'),
});
export type SkillRequirementConfig = z.infer<typeof skillRequirementConfigSchema>;
...
export type CreatePlanningRuleInput = z.infer<typeof createPlanningRuleSchema>;
...
export type UpdatePlanningRuleInput = z.infer<typeof updatePlanningRuleSchema>;
...
export type TogglePlanningRuleInput = z.infer<typeof togglePlanningRuleSchema>;
...
export const validateShiftsSchema = z
  .object({
